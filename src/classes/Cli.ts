    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle.vin === truck.vin) {
          console.log(colors.yellow(`The truck cannot tow itself.`));
          this.performActions();
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (selectedVehicle instanceof Truck) {
            ...
            console.error(colors.yellow('The selected vehicle is not a truck and cannot tow'))
          }
        ...
        // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          if (selectedVehicle instanceof Motorbike) {
            ...
            console.error(colors.yellow('The selected vehicle is not a motorbike and cannot do a wheelie.'));
